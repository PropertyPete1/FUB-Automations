    ...
    <div className="space-y-2">
      ...
      {isGenerating && !value ? (
        ...
        <Textarea
          ...
          className={`text-sm resize-none min-h-[80px] bg-white border-amber-200 focus-visible:ring-amber-400 text-slate-700 placeholder:text-slate-300 ${
      ...
      <div className="flex items-center justify-between">
        <span className={`text-[10px] font-mono ${isOverLimit ? "text-red-400 font-semibold" : "text-slate-300"}`}>
...
export default function SmsQueue() {
  ...
  if (queueLoading) {
    return (
      <div className="min-h-screen bg-[#F8F9FC] font-sans antialiased">
        {/* Skeleton header */}
        <header className="sticky top-0 z-40 bg-white border-b border-[#E4E7EF]">
        ...
        <main className="container max-w-2xl px-4 py-6 space-y-5">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="bg-white border border-[#E4E7EF] rounded-xl p-3 space-y-1.5">
          ...
          {/* Lead card skeleton */}
          <div className="bg-white border border-[#E4E7EF] rounded-2xl p-5 space-y-4">
          ...
          <div className="space-y-2">
            ...
            {[...Array(2)].map((_, i) => (
              <div key={i} className="bg-white border border-[#E4E7EF] rounded-xl p-3 flex items-center gap-3">
                <div className="h-8 w-8 rounded-full bg-slate-100 animate-pulse" />
                <div className="space-y-1.5">
                  <div className="h-3 w-28 bg-slate-100 rounded animate-pulse" />
                  <div className="h-2.5 w-20 bg-slate-100 rounded animate-pulse" />
  ...
  if (queueError) {
    return (
      <div className="min-h-screen bg-[#F8F9FC] flex items-center justify-center">
        <Card className="bg-slate-50 border-[#E4E7EF] p-8 max-w-sm text-center space-y-3">
          ...
          <Button onClick={() => refetch()} size="sm" variant="outline" className="border-[#E4E7EF] text-slate-600">Retry</Button>
        </Card>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC]">
      {/* ── iOS Install Banner ── */}
      {showInstallBanner && (
        <div className="bg-white border-b border-amber-200 px-4 py-2.5">
          <div className="container max-w-2xl flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <p className="text-xs text-slate-600">
                ...
                {" — tap "}
                <span className="font-mono bg-slate-100 px-1 py-0.5 rounded text-[10px]">Share</span>
                {" then "}
                <span className="font-mono bg-slate-100 px-1 py-0.5 rounded text-[10px]">Add to Home Screen</span>
      ...
      {/* ── Header ── */}
      <header className="sticky top-0 z-30 bg-[#F8F9FC]/95 backdrop-blur-sm border-b border-[#E4E7EF] px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-sm font-bold text-[#0F1117] tracking-tight">Power Queue</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex flex-col items-end gap-0.5">
              <Button
                ...
                size="sm"
                onClick={() => refetch()}
                className="h-8 gap-1.5 text-xs text-slate-500 border-[#E4E7EF] bg-slate-50 hover:bg-slate-100 hover:text-slate-700"
              >
          ...
          <div className="relative overflow-hidden bg-gradient-to-r from-slate-50 via-white to-slate-50 border-b border-emerald-200">
            ...
            <div className="container max-w-2xl px-4 py-4 flex items-center justify-between">
              ...
              <Button
                ...
                className="h-7 gap-1.5 text-xs text-slate-500 border-[#E4E7EF] bg-slate-50 hover:bg-slate-100 hover:text-slate-700"
              >
      ...
      <main className="container max-w-2xl px-4 py-6 space-y-5">
        ...
        <div className={`grid gap-3 ${agentDisplayName && dailyGoalData ? 'grid-cols-4' : 'grid-cols-3'}`}>
          <div className="bg-slate-50 border border-[#E4E7EF] rounded-xl p-3 text-center">
            {priorityCount > 0 ? (
              ...
              <>
                <div className="text-2xl font-bold text-[#0F1117]">{filteredLeads.length}</div>
          ...
          {agentDisplayName && dailyGoalData && (
            <div className="bg-slate-50 border border-[#E4E7EF] rounded-xl p-3 text-center relative overflow-hidden">
              {/* SVG progress ring */}
        ...
        {lockedAgent ? (
          ...
          (() => {
            ...
            return (
              <Card className="bg-slate-50 border-[#E4E7EF]">
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-9 h-10 border-[#E4E7EF] bg-slate-50 text-slate-700 placeholder:text-slate-300 focus-visible:ring-amber-500/40"
            />
          </div>
          ...
          {lockedAgent ? (
            ...
            <div className="w-full sm:w-44">
              <Select value={selectedAgent} onValueChange={setSelectedAgent}>
                <SelectTrigger className="h-10 border-[#E4E7EF] bg-slate-50 text-slate-600 focus:ring-amber-500/40">
                  <Filter className="h-3.5 w-3.5 mr-2 text-slate-400" />
                  <SelectValue placeholder="Filter by Agent" />
                </SelectTrigger>
                <SelectContent className="bg-white border-[#E4E7EF] text-slate-700">
        ...
        {filteredLeads.length === 0 ? (
          ...
          <Card className="bg-gradient-to-b from-emerald-950/40 to-[#F8F9FC] border-emerald-200 py-12 text-center">
            <div className="max-w-sm mx-auto space-y-5">
              ...
              <div className="space-y-1.5">
                <h3 className="text-xl font-bold text-[#0F1117]">Your Queue is Done! 🎉</h3>
                <p className="text-sm text-slate-500">
              ...
              <div className="space-y-3">
                ...
                <Card className={`bg-[#141210] border transition-all duration-300 ${
                  ...
                  <div className="p-5 space-y-5">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-2">
                        <div className="flex flex-wrap items-center gap-2">
                          <h2 className="text-xl font-bold text-[#0F1117] flex items-center gap-2">
                            {lead.name}
                            {isTexted && (
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Badge variant="outline" className="bg-slate-50 text-slate-500 border-[#E4E7EF] text-[10px]">
                            {lead.stage}
                          </Badge>
                          <Badge className="bg-slate-100 text-slate-600 hover:bg-slate-200 text-[10px]">
                            {lead.assigned_agent}
                          </Badge>
                          {lead.is_priority ? (
                    ...
                    {/* Notes preview */}
                    {lead.notes && (
                      <div className="bg-slate-50 border border-[#E4E7EF] rounded-lg p-3 text-xs text-slate-500 space-y-1">
                    ...
                    <div className="flex flex-col gap-2 pt-1">
                      ...
                      {/* Row 2: Skip / Snooze / Call — equal thirds */}
                      <div className="flex gap-2">
                        <Button
                          onClick={handleSkip}
                          variant="outline"
                          className="flex-1 h-10 rounded-xl border-[#E4E7EF] text-slate-500 hover:bg-slate-100 hover:text-slate-700 flex items-center justify-center gap-1.5"
                        >
                        ...
                        <Button
                          ...
                          className="flex-1 h-10 rounded-xl border-[#E4E7EF] text-slate-400 hover:bg-amber-500/10 hover:text-amber-600 hover:border-amber-500/30 flex items-center justify-center gap-1.5 transition-colors"
                        >
                        ...
                        <Button
                          ...
                          className="flex-1 h-10 rounded-xl border-[#E4E7EF] text-slate-400 hover:bg-emerald-500/10 hover:text-emerald-600 hover:border-emerald-500/30 flex items-center justify-center gap-1.5 transition-colors"
                        >
                  ...
                  <div className="space-y-2">
                    ...
                    {filteredLeads.slice(currentIndex + 1, currentIndex + 4).map((nextLead, i) => (
                      <button
                        ...
                        className="w-full text-left bg-white/[0.03] hover:bg-white/[0.06] border border-[#E4E7EF] rounded-lg px-4 py-3 flex items-center justify-between transition-colors"
                      >
                        <div className="flex items-center gap-3">
