        ...
        {error ? (
          ...
          <div className="w-full max-w-xs pt-4 transition-all duration-500">
            {redirectAttempted ? (
              ...
              <button
                onClick={handleManualClick}
                className="w-full py-3.5 px-6 bg-transparent hover:bg-white/5 border border-amber-500/20 active:scale-[0.98] transition-all text-amber-200/80 font-light tracking-wider uppercase text-xs rounded-full flex items-center justify-center gap-2"
              >
