          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 tracking-wide">
                Lifestyle Design Realty <span className="text-amber-500/40">·</span> Select your dashboard
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Badge className="bg-amber-950/60 text-amber-600 border border-amber-200 hover:bg-amber-950/60 text-[10px] px-2 py-0.5 font-mono">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-50 via-white to-slate-50 border-b border-amber-100">
        ...
        <div className="container max-w-4xl px-4 py-10 text-center">
          ...
          <div className="flex items-center justify-center gap-1.5 mt-4">
            ...
            <span className="text-[10px] text-amber-500 font-mono tracking-wider uppercase">Live Data from Follow Up Boss</span>
          </div>
        </div>
      ...
      <main className="container max-w-4xl px-4 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {AGENTS.map((agent) => (
            <Link key={agent.name} href={`/agent/${agent.name.toLowerCase()}`}>
              <Card className="group relative overflow-hidden bg-[#111008] border border-amber-100 hover:border-amber-500/30 transition-all duration-300 hover:shadow-[0_0_24px_rgba(212,175,55,0.08)] cursor-pointer">
                ...
                <div className="p-6 flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {agent.isOwner && (
                        <span className="text-[9px] font-bold tracking-widest uppercase px-1.5 py-0.5 rounded bg-amber-100 text-amber-700 border border-amber-500/30">Owner</span>
                      )}
                    </div>
                  ...
                  {/* Arrow */}
                  <ArrowRight className="h-4 w-4 text-slate-300 group-hover:text-amber-600 group-hover:translate-x-0.5 transition-all duration-200 flex-shrink-0" />
                </div>
        ...
        <div className="mt-10 text-center space-y-2">
          <p className="text-xs text-slate-300">
            <span className="text-amber-500/70">Tip:</span> Bookmark your personal dashboard URL for instant daily access from any device.
          </p>
          <p className="text-[10px] text-slate-700 tracking-[0.2em] uppercase">
