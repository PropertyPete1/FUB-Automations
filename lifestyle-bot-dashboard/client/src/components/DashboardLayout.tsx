...
import { Bot, LayoutDashboard, Droplets, ExternalLink, Zap, LogOut } from "lucide-react";
...
function DashboardLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC] text-[#0F1117] font-sans antialiased">
      {/* Top nav — exact match to FUB Nurture header */}
      <header className="sticky top-0 z-40 w-full bg-white border-b border-[#E4E7EF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* External link to FUB Nurture */}
            <a
              href="https://fub-nurture-phfprjui.manus.space"
              target="_blank"
      ...
      {/* Main content — full width, matching FUB Nurture */}
